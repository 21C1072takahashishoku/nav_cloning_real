...
class nav_cloning_node:
    def __init__(self):
        ...
        self.path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/result_EBV_day'+str(self.mode)+'/'
        self.save_path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/model_EBV_day'+str(self.mode)+'/'
        self.pos_x = 0.0
        self.pos_y = 0.0
        self.pos_the = 0.0
