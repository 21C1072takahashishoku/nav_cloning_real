...
class nav_cloning_node:
    def __init__(self):
        ...
        self.path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/result_EBV_night'+str(self.mode)+'/'
        self.save_path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/model_EBV_night'+str(self.mode)+'/'
        self.pos_x = 0.0
        self.pos_y = 0.0
        self.pos_the = 0.0
    ...
    def loop(self):
        ...
        img, self.baseline = self.generate_events(img, self.baseline)
        ...
        img_left, self.baseline_left = self.generate_events(img_left, self.baseline_left)
        ...
        img_right, self.baseline_right = self.generate_events(img_right, self.baseline_right)
